...
class Caltech(VisionDataset):
  def __init__(self, root, split = 'train', transform = None, target_transform = None):
    ...
    # data_dir = os.path.abspath(os.path.join(current_dir, "/data/Homework2-Caltech101/101_ObjectCategories"))
    file = open(self.root + self.split + ".txt", 'r')
    lines = file.readlines()
    index = 0
    class_index = 0
    for line in lines:
...
DATA_DIR = "./data/Homework2-Caltech101/"
